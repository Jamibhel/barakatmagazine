// "BARAKAT" - Collector's Birthday Edition · Volume 34
// Authentic Family Voice, Sibling Hype, Oríkì Àbẹ̀fẹ́ & Genuine Pride

const MAGAZINE_DATA = {
  profile: {
    name: "Bello Barakat Omolabake Abefe",
    firstName: "Barakat",
  ...
  heritage: {
    ...
    orikiYoruba: `
      ...
      Ẹlẹ́yinjú ẹgẹ́, ọmọ ológo dídán.<br>
      Àbẹ̀fẹ́ Ọmọlábákẹ́, ọmọ tí a bá kẹ́, tí a bá gẹ̀.<br>
      Ìrìn rẹ ń fọlá hàn, ẹ̀rín rẹ ń mú inú dídùn wá sílé.<br>
      Wà á gbó, wà á tọ́, wà á jẹun ọmọ pé lórí ilẹ̀.<br>
      Àbẹ̀fẹ́, ayọ̀ rẹ kò ní d’omi láéláé!
    `,
    orikiEnglish: `
      (Àbẹ̀fẹ́! The one whom we plead and strive to love, the one sought after by all with deep devotion. The graceful eyed one, child of radiant honor. Àbẹ̀fẹ́ Ọmọlábákẹ́, the precious child destined to be pampered, cherished, and treated like royalty. Your graceful steps radiate honor, and your smile brings boundless joy to the home. You will live long, you will prosper, you will eat the fruits of your labor in health, and your joy will never run dry! 🤍✨)
    `
  },
  ...
  academics: {
    ...
    videos: [
      "barakat pictures/Graduation.mp4",
      "barakat pictures/Graduation 5.mp4",
      "barakat pictures/Graduation (2).mp4",
  ...
  gallorizzy: {
    ...
    moments: [
      ...
      { image: "barakat pictures/q.jpg", label: "Golden Hour 💄" },
      { image: "barakat pictures/2019.jpg", label: "Classic Vibe 👟" },
      { image: "barakat pictures/@30 (2).jpg", label: "Power Glam 💖" },
      { image: "barakat pictures/2d.jpg", label: "Night Out 🍷" },
      { image: "barakat pictures/2c.jpg", label: "Red & Fur 🍷" },
      { video: "barakat pictures/2a.mp4", label: "Star Stroll 💃" },
      { video: "barakat pictures/@32 (2).mp4", label: "Rooftop Glow ✨" },
      { video: "barakat pictures/2b.mp4", label: "Glamour Motion 💃" }
    ]
  },
  ...
  initialTributes: [
    {
      ...
      date: "September 2026",
      mediaUrl: "barakat pictures/siblings and i.JPG",
      mediaType: "image"
    }
  ]
};

window.MAGAZINE_DATA = MAGAZINE_DATA;
