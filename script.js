  ...
  sorted.forEach(item => {
    ...
    if (item.mediaUrl) {
      if (item.mediaType === 'video') {
        mediaHtml = `
          <div class="tribute-media-frame">
            <video src="${item.mediaUrl}" controls class="tribute-media-thumb"></video>
          </div>
        `;
      } else {
        mediaHtml = `
          <div class="tribute-media-frame">
            <img src="${item.mediaUrl}" alt="Tribute memory" class="tribute-media-thumb">
          </div>
        `;
      }
    }
